...
$msbuildExe = Join-Path $toolsLocalPath "msbuild.dll"
$updateProj = Join-Path $PSScriptRoot "build.proj"
& $dotNetExe $msbuildExe $updateProj /t:UpdateDependenciesAndSubmitPullRequest $args
exit $LastExitCode