...
namespace System.ServiceModel.Channels
{
    public sealed class MessageProperties : IDictionary<string, object>, IDisposable
    {
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ObjectDisposedException(string.Empty, SRP.Format(SRP.ObjectDisposed, GetType().ToString())));
        }
        ...
        public object this[string name]
        {
            get
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRP.Format(SRP.MessagePropertyNotFound, name)));
                }
        ...
        public void Add(string name, object property)
        {
            ...
            if (property == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentNullException(nameof(property)));
            }
        ...
        internal void MergeProperties(MessageProperties properties)
        {
            ...
            if (properties._properties != null)
            {
                for (int i = 0; i < properties._properties.Length; i++)
                {
                    ...
                    if (!TryGetValue(property.Name, out currentValue) ||
        ...
        private object CreateCopyOfPropertyValue(object propertyValue)
        {
            ...
            if (copy == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRP.MessagePropertyReturnedNullCopy));
            }
        ...
        private void UpdateProperty(string name, object value, bool mustNotExist)
        {
            ...
            if (index != NotFoundIndex)
            {
                if (mustNotExist)
                {
                    ...
                    if (exists)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRP.Format(SRP.DuplicateMessageProperty, name)));
                    }
                }
        ...
        void ICollection<KeyValuePair<string, object>>.CopyTo(KeyValuePair<string, object>[] array, int index)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRP.MessagePropertiesArraySize0));
            }
            ...
            if (index < 0 || index > array.Length - _propertyCount)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(index), index,
                                                    SRP.Format(SRP.ValueMustBeInRange, 0, array.Length - _propertyCount)));
            }
