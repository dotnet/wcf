...
if [%PSEXEC_PATH%]==[] (
  ...
  call %~dp0..\..\..\..\artifacts\obj\SelfHostedWCFService\Debug\SelfHostedWcfService.exe
  set __EXITCODE=%ERRORLEVEL%
  goto Cleanup
)
...
if exist %PSEXEC_PATH%\psexec.exe (
  ...
  echo call %PSEXEC_PATH%\psexec.exe -s -h %~dp0..\..\..\..\artifacts\obj\SelfHostedWCFService\Debug\SelfHostedWcfService.exe >>%_setuplog%
  REM This next call blocks until the service is terminated
  call %PSEXEC_PATH%\psexec.exe -s -h %~dp0..\..\..\..\artifacts\obj\SelfHostedWCFService\Debug\SelfHostedWcfService.exe
  set __EXITCODE=%ERRORLEVEL%
  goto Cleanup
)
