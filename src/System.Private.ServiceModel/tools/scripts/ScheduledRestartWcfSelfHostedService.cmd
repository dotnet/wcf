...
echo [%~n0] START %_GITREPO%\bin\Wcf\tools\SelfHostedWcfService\SelfHostedWcfService.exe >> %_LOGFILE%
start %_GITREPO%\bin\Wcf\tools\SelfHostedWcfService\SelfHostedWcfService.exe > %_SVCLOG% 2>&1
