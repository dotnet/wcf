...
{
    public class HttpSoap11WSA10TestServiceHostFactory : ServiceHostFactory
    {
        protected override ServiceHost CreateServiceHost(Type serviceType, Uri[] baseAddresses)
        {
            HttpSoap11WSA10TestServiceHost serviceHost = new HttpSoap11WSA10TestServiceHost(serviceType, baseAddresses);
            return serviceHost;
        }
    }
    public class HttpSoap11WSA10TestServiceHost : TestServiceHostBase<IWcfService>
    {
        ...
        public HttpSoap11WSA10TestServiceHost(Type serviceType, params Uri[] baseAddresses)
