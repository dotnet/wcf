...
namespace WcfService
{
    ...
    public class TcpCertificateWithSubjectCanonicalNameDomainNameTestServiceHost : TestServiceHostBase<IWcfService>
    {
        ...
        protected override void ApplyConfiguration()
        {
            ...
            X509Certificate2 cert = TestHost.CertificateFromFriendlyName(StoreName.My, StoreLocation.LocalMachine, "WCF Bridge - TcpCertificateWithSubjectCanonicalNameDomainNameResource");
