...
namespace WcfService
{
    ...
    public class TcpCertificateWithSubjectCanonicalNameFqdnTestServiceHost : TestServiceHostBase<IWcfService>
    {
        ...
        protected override void ApplyConfiguration()
        {
            ...
            {
                string certThumprint = Util.CertificateFromFridendlyName(StoreName.My, StoreLocation.LocalMachine, "WCF Bridge - TcpCertificateWithSubjectCanonicalNameFqdnResource").Thumbprint;
