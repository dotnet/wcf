...
{
    [TestServiceDefinition(BasePath = "ReliableSessionService.svc", Schema = ServiceSchema.HTTP | ServiceSchema.NETTCP)]
    public class ReliableSessionSerivceHost : TestServiceHostBase<IWcfReliableService>
    {
        ...
        public ReliableSessionSerivceHost(params Uri[] baseAddresses)
