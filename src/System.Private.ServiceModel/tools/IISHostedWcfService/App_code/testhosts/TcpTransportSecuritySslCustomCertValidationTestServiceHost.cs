...
namespace WcfService
{
    ...
    public class TcpTransportSecuritySslCustomCertValidationTestServiceHost : TestServiceHostBase<IWcfService>
    {
        ...
        protected override void ApplyConfiguration()
        {
            ...
            string thumbprint = Util.CertificateFromFriendlyName(StoreName.My, StoreLocation.LocalMachine, "WCF Bridge - Machine certificate generated by the CertificateManager").Thumbprint;
