...
namespace WcfService
{
    ...
    public interface ITestHost
    {
        ...
        [OperationContract]
        [WebGet(UriTemplate = "Crl?serialNum={serialNum}", BodyStyle = WebMessageBodyStyle.Bare)]
        Stream Crl(string serialNum);

        [OperationContract]
        [WebGet(UriTemplate = "PeerCert?asPem={asPem}", BodyStyle = WebMessageBodyStyle.Bare)]
        byte[] PeerCert(bool asPem);
    ...
    public class TestHost : ITestHost
    {
        ...
        public Stream Crl(string serialNum)
        {
        ...
        public byte[] PeerCert(bool asPem)
        {
