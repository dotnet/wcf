...
namespace Web.Models
{
    ...
    static class TypeCache
    {
        ...
        private static IDictionary<string, List<string>> cache = new Dictionary<string, List<string>>();

        public static Dictionary<string, AppDomain> AppDomains { get { return appDomains; } }

        public static IDictionary<string, List<string>> Cache { get { return cache; } }
    }
}
