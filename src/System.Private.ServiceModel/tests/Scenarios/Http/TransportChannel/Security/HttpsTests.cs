...
public static class Http_TransportChannel_Security_HttpsTests
{
    ...
    {
        string testCaseName = "HttpsTransportBindingElement_ScenarioTests.SameBinding_Soap11_EchoString";
    ...
    {
        string testCaseName = "HttpsTransportBindingElement_ScenarioTests.SameBinding_Soap12_EchoString";
    ...
    {
        string testCaseName = "HttpsTransportBindingElement_ScenarioTests.CrossBinding_Soap11_EchoString";
