...
public class Binding_Http_BasicHttpBindingTests : OuterLoopTests
{
    public Binding_Http_BasicHttpBindingTests() : base("WcfService.TestResources.BasicHttpResource") { }
