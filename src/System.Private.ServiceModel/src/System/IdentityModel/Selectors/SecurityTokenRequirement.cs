...
namespace System.IdentityModel.Selectors
{
    public class SecurityTokenRequirement
    {
        ...
        public bool TryGetProperty<TValue>(string propertyName, out TValue result)
        {
            ...
            {
                throw Fx.Exception.Argument(propertyName, string.Format(SR.SecurityTokenRequirementHasInvalidTypeForProperty, propertyName, dictionaryValue.GetType(), typeof(TValue)));
            }
