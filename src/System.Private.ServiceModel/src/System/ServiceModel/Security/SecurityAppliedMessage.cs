...
namespace System.ServiceModel.Security
{
    internal sealed class SecurityAppliedMessage : DelegatingMessage
    {
        ...
        {
            return new InvalidOperationException(SR.Format(SR.MessageBodyOperationNotValidInBodyState, operation, _state));
        }
        ...
        private void EnsureUniqueSecurityApplication()
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.DelayedSecurityApplicationAlreadyCompleted));
            }
