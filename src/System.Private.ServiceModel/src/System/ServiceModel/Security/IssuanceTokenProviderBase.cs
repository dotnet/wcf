        ...
        where T : IssuanceTokenProviderState
    {
        ...
        public int ServiceTokenValidityThresholdPercentage
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException(nameof(value), SR.Format(SR.ValueMustBeInRange, 1, 100)));
                }
        ...
        public override Task OnOpenAsync(TimeSpan timeout)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.TargetAddressIsNotSet, GetType())));
            }
