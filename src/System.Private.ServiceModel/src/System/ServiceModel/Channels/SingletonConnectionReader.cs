    ...
    abstract class SingletonConnectionReader
    {
        ...
        class ReceiveAsyncResult : AsyncResult
        {
                ...
                : base(callback, state)
            {
                ...
                // FUTURE, kennyw, 43405: consider implementing this using connection.BeginRead()
        ...
        class SingletonInputConnectionStream : ConnectionStream
        {
            ...
            public class ReadAsyncResult : AsyncResult
            {
                    ...
                    : base(callback, state)
                {
                    ...
                    // FUTURE, kennyw, 49282: consider implementing this fully async if we ever make stream encoders support async
...
#pragma warning suppress 56500 // kennyw, transferring exception to another thread
                catch (Exception e)
                {
                    if (Fx.IsFatal(e))
                    {
