...
namespace System.ServiceModel.Channels
{
    public sealed class WebBodyFormatMessageProperty : IMessageProperty
    {
        ...
        public WebBodyFormatMessageProperty(WebContentFormat format)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.DefaultContentFormatNotAllowedInProperty));
            }
        ...
        public override string ToString() => SR.Format(SR.WebBodyFormatPropertyToString, Format.ToString());
    }
}
