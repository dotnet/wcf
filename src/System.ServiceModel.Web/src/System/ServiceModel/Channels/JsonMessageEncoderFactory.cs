...
namespace System.ServiceModel.Channels
{
    internal class JsonMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        {
            _messageEncoder = new JsonMessageEncoder(writeEncoding, maxReadPoolSize, maxWritePoolSize, quotas);
        }
        ...
        internal static string GetContentType(WebMessageEncodingBindingElement encodingElement) =>
            WebMessageEncoderFactory.GetContentType(
                JsonGlobals.ApplicationJsonMediaType,
                encodingElement == null ? TextEncoderDefaults.Encoding : encodingElement.WriteEncoding);
        ...
        private static ContentEncoding[] GetContentEncodingMap(string mediaType)
        {
            ...
            for (int i = 0; i < readEncodings.Length; i++)
            {
                ...
                {
                    ContentType = WebMessageEncoderFactory.GetContentType(mediaType, readEncodings[i]),
        ...
        internal class JsonMessageEncoder : MessageEncoder
        {
            ...
            internal class JsonBufferedMessageData : BufferedMessageData
            {
                ...
                private readonly ObjectPool<XmlDictionaryReader> _readerPool;
