    ...
    public sealed class WebMessageEncodingBindingElement : MessageEncodingBindingElement
    {
        ...
        public override MessageVersion MessageVersion
        {
            ...
            set
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument(nameof(value), SR.JsonOnlySupportsMessageVersionNone);
                }
            }
        }
        ...
        {
            return new WebMessageEncoderFactory(WriteEncoding, MaxReadPoolSize, MaxWritePoolSize, ReaderQuotas, ContentTypeMapper);
        }
