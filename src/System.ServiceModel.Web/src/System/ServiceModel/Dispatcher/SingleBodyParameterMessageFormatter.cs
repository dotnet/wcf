...
{
    internal abstract class SingleBodyParameterMessageFormatter : IClientMessageFormatter
    {
        ...
        public Message SerializeRequest(MessageVersion messageVersion, object[] parameters)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.FormatterCannotBeUsedForRequestMessages));
            }
        ...
        public object DeserializeReply(Message message, object[] parameters)
        {
            if (_isRequestFormatter)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.FormatterCannotBeUsedForReplyMessages));
            }
        ...
        internal static void SuppressRequestEntityBody(Message message)
        {
            ...
            {
                currentContext.OutgoingRequest.SuppressEntityBody = true;
            }
            else
            {
                object prop;
        ...
        internal class NullMessageFormatter : IClientMessageFormatter
        {
            public object DeserializeReply(Message message, object[] parameters)
            {
                return null;
