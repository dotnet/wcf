...
namespace System.ServiceModel.Dispatcher
{
    internal class DataContractJsonSerializerOperationFormatter : DataContractSerializerOperationFormatter
    {
        ...
        public DataContractJsonSerializerOperationFormatter(OperationDescription description, int maxItemsInObjectGraph, bool ignoreExtensionDataObject, bool isWrapped)
            : base(description, s_defaultDataContractFormatAttribute, new DataContractJsonSerializerOperationBehavior(description, maxItemsInObjectGraph, ignoreExtensionDataObject, false))
        {
