...
namespace System
{
    internal static class UriTemplateHelpers
    {
        ...
        private static readonly UriTemplateQueryKeyComparer s_queryKeyComparer = new UriTemplateQueryKeyComparer();
        ...
        public static void DisambiguateSamePath(UriTemplate[] array, int a, int b, bool allowDuplicateEquivalentUriTemplates)
        {
            ...
            Array.Sort<UriTemplate>(array, a, b - a, s_queryComparer);
            if (b - a == 1)
            {
        ...
        public static UriTemplatePartType IdentifyPartType(string part)
        {
            ...
            // - Finding the position of the first open curly brace ('{') and close curly brace ('}')
            // in the string
