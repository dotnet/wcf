...
namespace System
{
    ...
    internal class UriTemplateCompoundPathSegment : UriTemplatePathSegment, IComparable<UriTemplateCompoundPathSegment>
    {
        ...
        // the preferred class, based on the order we defined them (p+s \ p \ s \ n).
        ...
        // implicitly (we preferred the prefix only class over the suffix only, we also preferred literal
        ...
        int IComparable<UriTemplateCompoundPathSegment>.CompareTo(UriTemplateCompoundPathSegment other)
        {
            ...
            switch (_csClass)
            {
                ...
                default:
                    Fx.Assert("Invalid CompoundSegmentClass");
                    return 0;
            }
        }
