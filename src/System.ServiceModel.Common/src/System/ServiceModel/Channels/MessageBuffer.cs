...
namespace System.ServiceModel.Channels
{
    ...
    {
        // Copied from FramingEncodingString.Binary
        internal const string Binary = "application/soap+msbin1";
        internal const string NullMessageTypeName = "System.ServiceModel.Channels.NullMessage";
    ...
    internal class DefaultMessageBuffer : MessageBuffer
    {
        ...
        public DefaultMessageBuffer(Message message, XmlBuffer msgBuffer)
        {
            ...
            _isNullMessage = _messageType.FullName.Equals(NullMessageTypeName);
        ...
        public override Message CreateMessage()
        {
            ...
            if (_isNullMessage)
            {
                // Create a new Null message using the type from the NullMessage originally passed in.
                msg = (Message)Activator.CreateInstance(_messageType);
            }
            else
            {
