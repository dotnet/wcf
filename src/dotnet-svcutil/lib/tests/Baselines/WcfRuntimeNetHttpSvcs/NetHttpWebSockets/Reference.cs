...
namespace NetHttpWebSockets_NS
{
    ...
    public partial class WcfServiceClient : System.ServiceModel.ClientBase<NetHttpWebSockets_NS.IWcfService>, NetHttpWebSockets_NS.IWcfService
    {
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.NetHttpWebSockets_IWcfService.ToString();
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.NetHttpWebSockets_IWcfService))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.NetHttpWebSockets_IWcfService))
            {
                return new System.ServiceModel.EndpointAddress("ws://wcfcoresrv53/WcfTestService1/NetHttpWebSockets.svc/NetHttpWebSockets");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        {
            return WcfServiceClient.GetBindingForEndpoint(EndpointConfiguration.NetHttpWebSockets_IWcfService);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return WcfServiceClient.GetEndpointAddress(EndpointConfiguration.NetHttpWebSockets_IWcfService);
        }
        
        public enum EndpointConfiguration
        {
            
            NetHttpWebSockets_IWcfService,
        }
    }
}