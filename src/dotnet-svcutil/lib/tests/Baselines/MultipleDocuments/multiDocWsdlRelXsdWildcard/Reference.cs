...
namespace multiDocWsdlRelXsdWildcard_NS
{
    ...
    public partial class ResultOfArrayOfUserGamePlay : object, System.Runtime.Serialization.IExtensibleDataObject
    {
        ...
        private multiDocWsdlRelXsdWildcard_NS.UserGamePlay[] ResultField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public multiDocWsdlRelXsdWildcard_NS.UserGamePlay[] Result
        {
            get
            {
                return this.ResultField;
    ...
    public interface IWcfProjectNService
    {
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ComplexCompositeType> EchoComplexAsync(multiDocWsdlRelXsdWildcard_NS.ComplexCompositeType message);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(multiDocWsdlRelXsdWildcard_NS.FaultDetail), Action="http://tempuri.org/IWcfProjectNService/TestFaultFaultDetailFault", Name="FaultDetail", Namespace="http://schemas.wcf.projectn.com/wcfnamespace")]
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.CompositeType> GetDataUsingDataContractAsync(multiDocWsdlRelXsdWildcard_NS.CompositeType composite);
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ResultOfstring> UserGetAuthTokenAsync(string liveId);
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ResultOfArrayOfUserGamePlay> UserGamePlayGetListAsync(string gameKey, string keys);
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ReplyBankingData> MessageContractRequestReplyAsync(multiDocWsdlRelXsdWildcard_NS.RequestBankingData request);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfProjectNService/MessageContractRequestReplyNotWrapped", ReplyAction="http://tempuri.org/IWcfProjectNService/MessageContractRequestReplyNotWrappedRespo" +
            "nse")]
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ReplyBankingDataNotWrapped> MessageContractRequestReplyNotWrappedAsync(multiDocWsdlRelXsdWildcard_NS.RequestBankingData request);
        ...
        System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.TestHttpRequestMessageProperty> EchoHttpRequestMessagePropertyAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "99.99.99")]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverageAttribute()]
    public partial class WcfProjectNServiceClient : System.ServiceModel.ClientBase<multiDocWsdlRelXsdWildcard_NS.IWcfProjectNService>, multiDocWsdlRelXsdWildcard_NS.IWcfProjectNService
    {
        ...
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ComplexCompositeType> EchoComplexAsync(multiDocWsdlRelXsdWildcard_NS.ComplexCompositeType message)
        {
        ...
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.CompositeType> GetDataUsingDataContractAsync(multiDocWsdlRelXsdWildcard_NS.CompositeType composite)
        {
        ...
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ResultOfstring> UserGetAuthTokenAsync(string liveId)
        {
            return base.Channel.UserGetAuthTokenAsync(liveId);
        }
        
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ResultOfArrayOfUserGamePlay> UserGamePlayGetListAsync(string gameKey, string keys)
        {
            return base.Channel.UserGamePlayGetListAsync(gameKey, keys);
        }
        
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ReplyBankingData> MessageContractRequestReplyAsync(multiDocWsdlRelXsdWildcard_NS.RequestBankingData request)
        {
            return base.Channel.MessageContractRequestReplyAsync(request);
        }
        
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.ReplyBankingDataNotWrapped> MessageContractRequestReplyNotWrappedAsync(multiDocWsdlRelXsdWildcard_NS.RequestBankingData request)
        {
            return base.Channel.MessageContractRequestReplyNotWrappedAsync(request);
        }
        
        public System.Threading.Tasks.Task<multiDocWsdlRelXsdWildcard_NS.TestHttpRequestMessageProperty> EchoHttpRequestMessagePropertyAsync()
        {
