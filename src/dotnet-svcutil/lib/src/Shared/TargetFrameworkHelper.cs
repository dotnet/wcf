    ...
    internal class TargetFrameworkHelper
    {
        ...
        internal static SortedDictionary<Version, List<ProjectDependency>> NetCoreVersionReferenceTable = new SortedDictionary<Version, List<ProjectDependency>>
        {
            ...
            {new Version("7.0"), new List<ProjectDependency> {
                ProjectDependency.FromPackage("System.ServiceModel.Duplex", "6.0.0-preview1.23060.3"  ),
                ProjectDependency.FromPackage("System.ServiceModel.Http", "6.0.0-preview1.23060.3"    ),
                ProjectDependency.FromPackage("System.ServiceModel.NetTcp", "6.0.0-preview1.23060.3"  ),
                ProjectDependency.FromPackage("System.ServiceModel.Security", "6.0.0-preview1.23060.3"),
                ProjectDependency.FromPackage("System.ServiceModel.Federation", "6.0.0-preview1.23060.3"),
                ProjectDependency.FromPackage("System.ServiceModel.NetNamedPipe", "6.0.0-preview1.23060.3")
            } }
        };
