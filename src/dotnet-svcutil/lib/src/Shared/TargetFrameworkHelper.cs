...
namespace Microsoft.Tools.ServiceModel.Svcutil
{
    internal class TargetFrameworkHelper
    {
        ...
        internal static List<ProjectDependency> ServiceModelPackages = new List<ProjectDependency>()
        {
            ...
            ProjectDependency.FromPackage("System.Security.AccessControl", "*"),
            ProjectDependency.FromPackage("System.Security.Cryptography.Cng", "*"),
            ProjectDependency.FromPackage("System.Security.Cryptography.Xml", "*"),
            ProjectDependency.FromPackage("System.Security.Permissions", "*"),
            ProjectDependency.FromPackage("System.Security.Principal.Windows", "*"),
            ProjectDependency.FromPackage("System.Text.Encoding", "*"),
            ProjectDependency.FromPackage("System.Threading.Tasks", "*"),
            ProjectDependency.FromPackage("System.Windows.Extensions", "*"),
            ProjectDependency.FromPackage("System.Xml.ReaderWriter", "*"),
            ProjectDependency.FromPackage("System.Xml.XmlDocument", "*"),
