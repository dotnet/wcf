...
namespace System.Text
{
    internal class Base64Encoding : Encoding
    {
        ...
        {
            if (charCount < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("charCount", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if ((charCount % 4) != 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRSerialization.Format(SRSerialization.XmlInvalidBase64Length, charCount.ToString(NumberFormatInfo.CurrentInfo))));
        ...
        unsafe public override int GetByteCount(char[] chars, int index, int count)
        {
            ...
            if (index < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("index", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if (index > chars.Length)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("index", SRSerialization.Format(SRSerialization.OffsetExceedsBufferSize, chars.Length)));
            if (count < 0)
            ...
            if (count > chars.Length - index)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", SRSerialization.Format(SRSerialization.SizeExceedsRemainingBufferSpace, chars.Length - index)));

            if (count == 0)
                return 0;
            if ((count % 4) != 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRSerialization.Format(SRSerialization.XmlInvalidBase64Length, count.ToString(NumberFormatInfo.CurrentInfo))));
                ...
                fixed (char* _chars = &chars[index])
                {
                    ...
                    while (pch < pchMax)
                    {
                        ...
                        if ((pch0 | pch1 | pch2 | pch3) >= 128)
                            throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRSerialization.Format(SRSerialization.XmlInvalidBase64Sequence, new string(pch, 0, 4), index + (int)(pch - _chars))));
        ...
        unsafe public override int GetBytes(char[] chars, int charIndex, int charCount, byte[] bytes, int byteIndex)
        {
            ...
            if (charIndex < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("charIndex", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if (charIndex > chars.Length)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("charIndex", SRSerialization.Format(SRSerialization.OffsetExceedsBufferSize, chars.Length)));

            if (charCount < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("charCount", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if (charCount > chars.Length - charIndex)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("charCount", SRSerialization.Format(SRSerialization.SizeExceedsRemainingBufferSpace, chars.Length - charIndex)));

            if (bytes == null)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentNullException("bytes"));
            if (byteIndex < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteIndex", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if (byteIndex > bytes.Length)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteIndex", SRSerialization.Format(SRSerialization.OffsetExceedsBufferSize, bytes.Length)));
                ...
                fixed (char* _chars = &chars[charIndex])
                {
                    fixed (byte* _bytes = &bytes[byteIndex])
                    {
                        ...
                        while (pch < pchMax)
                        {
                            ...
                            if ((pch0 | pch1 | pch2 | pch3) >= 128)
                                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRSerialization.Format(SRSerialization.XmlInvalidBase64Sequence, new string(pch, 0, 4), charIndex + (int)(pch - _chars))));
                            // xx765432 xx107654 xx321076 xx543210
                            // 76543210 76543210 76543210
                            ...
                            if (pb + byteCount > pbMax)
                                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRSerialization.Format(SRSerialization.XmlArrayTooSmall), "bytes"));
                ...
                fixed (byte* _chars = &chars[charIndex])
                {
                    fixed (byte* _bytes = &bytes[byteIndex])
                    {
                        ...
                        while (pch < pchMax)
                        {
                            ...
                            byte pch3 = pch[3];
                            if ((pch0 | pch1 | pch2 | pch3) >= 128)
                                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SRSerialization.Format(SRSerialization.XmlInvalidBase64Sequence, "?", charIndex + (int)(pch - _chars))));
                            // xx765432 xx107654 xx321076 xx543210
                            // 76543210 76543210 76543210
        ...
        public override int GetMaxCharCount(int byteCount)
        {
            if (byteCount < 0 || byteCount > int.MaxValue / 4 * 3 - 2)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteCount", SRSerialization.Format(SRSerialization.ValueMustBeInRange, 0, int.MaxValue / 4 * 3 - 2)));
        ...
        unsafe public override int GetChars(byte[] bytes, int byteIndex, int byteCount, char[] chars, int charIndex)
        {
            ...
            if (byteIndex > bytes.Length)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteIndex", SRSerialization.Format(SRSerialization.OffsetExceedsBufferSize, bytes.Length)));
            if (byteCount < 0)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteCount", SRSerialization.Format(SRSerialization.ValueMustBeNonNegative)));
            if (byteCount > bytes.Length - byteIndex)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("byteCount", SRSerialization.Format(SRSerialization.SizeExceedsRemainingBufferSpace, bytes.Length - byteIndex)));
            ...
            if (charCount < 0 || charCount > chars.Length - charIndex)
                throw /*System.Runtime.Serialization.*/DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SRSerialization.Format(SRSerialization.XmlArrayTooSmall), "chars"));
