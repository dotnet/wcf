...
namespace Microsoft.Xml.Schema
{
    ...
    internal sealed class SchemaCollectionCompiler : BaseProcessor
    {
        ...
        private void CompileSubstitutionGroup(XmlSchemaSubstitutionGroupV1Compat substitutionGroup)
        {
            ...
            {
                SendValidationEvent(ResXml.Sch_NoExamplar, (XmlSchemaElement)substitutionGroup.Members[0]);
            }
            ...
            if (examplar != null)
            {
                for (int i = 0; i < substitutionGroup.Members.Count; ++i)
                {
                    ...
                    if (element != examplar)
                    {
                        ...
                        {
                            SendValidationEvent(ResXml.Sch_InvalidSubstitutionMember, (element.QualifiedName).ToString(), (examplar.QualifiedName).ToString(), element);
                        }
                    }
                }
            }
            ...
            try
            {
                if (simpleType.Content is XmlSchemaSimpleTypeList)
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new XmlSchemaException(ResXml.Sch_UndeclaredSimpleType, list.ItemTypeName.ToString(), simpleType);
                        }
                    }
                ...
                else if (simpleType.Content is XmlSchemaSimpleTypeRestriction)
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new XmlSchemaException(ResXml.Sch_UndeclaredSimpleType, restriction.BaseTypeName.ToString(), simpleType);
                        }
                    }
        ...
        private XmlSchemaSimpleType[] CompileBaseMemberTypes(XmlSchemaSimpleType simpleType)
        {
            ...
            if (mainMemberTypes != null)
            {
                for (int i = 0; i < mainMemberTypes.Length; ++i)
                {
                    ...
                    {
                        throw new XmlSchemaException(ResXml.Sch_UndeclaredSimpleType, mainMemberTypes[i].ToString(), simpleType);
                    }
                }
            }
        ...
        private void CompileSimpleContentExtension(XmlSchemaComplexType complexType, XmlSchemaSimpleContentExtension simpleExtension)
        {
            ...
            else
            {
                ...
                if (bto == null)
                {
                    SendValidationEvent(ResXml.Sch_UndeclaredType, simpleExtension.BaseTypeName.ToString(), complexType);
                }
                else
                {
        ...
        private void CompileComplexContentExtension(XmlSchemaComplexType complexType, XmlSchemaComplexContent complexContent, XmlSchemaComplexContentExtension complexExtension)
        {
            ...
            if (baseType != null && baseType.ElementDecl != null)
            {
                if (baseType.ContentType == XmlSchemaContentType.TextOnly)
                {
                    SendValidationEvent(ResXml.Sch_NotComplexContent, complexType);
                    return;
                }
            }
            complexType.SetBaseSchemaType(baseType);
        ...
        private void CompileComplexContentRestriction(XmlSchemaComplexType complexType, XmlSchemaComplexContent complexContent, XmlSchemaComplexContentRestriction complexRestriction)
        {
            ...
            if (complexType.ContentType == XmlSchemaContentType.Empty)
            {
                ...
                {
                    SendValidationEvent(ResXml.Sch_InvalidContentRestriction, complexType);
                }
            }
            complexType.SetDerivedBy(XmlSchemaDerivationMethod.Restriction);
        }
                ...
                { // XmlSchemaAttributeGroupRef
                    ...
                    if (attributeGroupResolved != null)
                    {
                        ...
                        foreach (XmlSchemaAttribute attributeValue in attributeGroupResolved.AttributeUses.Values)
                        {
                            ...
                            {
                                SendValidationEvent(ResXml.Sch_DupAttributeUse, attributeValue.QualifiedName.ToString(), attributeValue);
                            }
                        }
                    ...
                    if (attributeGroup != null)
                    {
                        ...
                        foreach (XmlSchemaAttribute attributeValue in attributeGroup.AttributeUses.Values)
                        {
                               ...
                               (attributeValue.Use == XmlSchemaUse.Prohibited && derivedBy == XmlSchemaDerivationMethod.Restriction && baseType != XmlSchemaComplexType.AnyType))
                            {
                                ...
                                {
                                    SendValidationEvent(ResXml.Sch_DupAttributeUse, attributeValue.QualifiedName.ToString(), attributeGroupRef);
                                }
                            }
                            else
                            {
                                SendValidationEvent(ResXml.Sch_AttributeIgnored, attributeValue.QualifiedName.ToString(), attributeValue, XmlSeverityType.Warning);
                            }
                        }
            ...
            else
            {
                ...
                catch (UpaException e)
                {
                    if (e.Particle1 is XmlSchemaElement)
                    {
                        ...
                        {
                            SendValidationEvent(ResXml.Sch_NonDeterministicAnyEx, ((XmlSchemaAny)e.Particle2).NamespaceList.ToString(), ((XmlSchemaElement)e.Particle1).QualifiedName.ToString(), (XmlSchemaAny)e.Particle2);
                        }
                    }
                    else
                    {
                        if (e.Particle2 is XmlSchemaElement)
                        {
                            SendValidationEvent(ResXml.Sch_NonDeterministicAnyEx, ((XmlSchemaAny)e.Particle1).NamespaceList.ToString(), ((XmlSchemaElement)e.Particle2).QualifiedName.ToString(), (XmlSchemaAny)e.Particle1);
                        }
                        else
                        {
                            SendValidationEvent(ResXml.Sch_NonDeterministicAnyAny, ((XmlSchemaAny)e.Particle1).NamespaceList.ToString(), ((XmlSchemaAny)e.Particle2).NamespaceList.ToString(), (XmlSchemaAny)e.Particle1);
                        }
                    }
