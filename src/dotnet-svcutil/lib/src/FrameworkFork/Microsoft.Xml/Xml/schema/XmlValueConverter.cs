...
namespace Microsoft.Xml.Schema
{
    ...
    // UNION MAPPINGS
    // ==============
    // Union types may only be represented using Microsoft.Xml.Schema.XmlAtomicValue or System.String.  Either the
    // source type or the destination type must therefore always be either System.String or
    // Microsoft.Xml.Schema.XmlAtomicValue.
    //
    // -----------------------------------------------------------------------------------------------------------
    ...
    internal abstract class XmlBaseConverter : XmlValueConverter
    {
        ...
        protected Exception CreateInvalidClrMappingException(Type sourceType, Type destinationType)
        {
            if (sourceType == destinationType)
                return new InvalidCastException(string.Format(ResXml.XmlConvert_TypeBadMapping, XmlTypeName, sourceType.Name));

            return new InvalidCastException(string.Format(ResXml.XmlConvert_TypeBadMapping2, XmlTypeName, sourceType.Name, destinationType.Name));
        }
        ...
        protected static XmlQualifiedName StringToQName(string value, IXmlNamespaceResolver nsResolver)
        {
            ...
            if (nsResolver == null)
                throw new InvalidCastException(string.Format(ResXml.XmlConvert_TypeNoNamespace, value, prefix));
        ...
        protected static string QNameToString(XmlQualifiedName qname, IXmlNamespaceResolver nsResolver)
        {
            ...
            if (prefix == null)
                throw new InvalidCastException(string.Format(ResXml.XmlConvert_TypeNoPrefix, qname.ToString(), qname.Namespace));
        ...
        internal static int DecimalToInt32(decimal value)
        {
            if (value < (decimal)Int32.MinValue || value > (decimal)Int32.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "Int32" }));
        ...
        protected static long DecimalToInt64(decimal value)
        {
            if (value < (decimal)Int64.MinValue || value > (decimal)Int64.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "Int64" }));
        ...
        protected static ulong DecimalToUInt64(decimal value)
        {
            if (value < (decimal)UInt64.MinValue || value > (decimal)UInt64.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "UInt64" }));
        ...
        protected static byte Int32ToByte(int value)
        {
            if (value < (int)Byte.MinValue || value > (int)Byte.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "Byte" }));
        ...
        protected static short Int32ToInt16(int value)
        {
            if (value < (int)Int16.MinValue || value > (int)Int16.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "Int16" }));
        ...
        protected static sbyte Int32ToSByte(int value)
        {
            if (value < (int)SByte.MinValue || value > (int)SByte.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "SByte" }));
        ...
        protected static ushort Int32ToUInt16(int value)
        {
            if (value < (int)UInt16.MinValue || value > (int)UInt16.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "UInt16" }));
        ...
        protected static uint Int64ToUInt32(long value)
        {
            if (value < (long)UInt32.MinValue || value > (long)UInt32.MaxValue)
                throw new OverflowException(string.Format(ResXml.XmlConvert_Overflow, new string[] { XmlConvert.ToString(value), "UInt32" }));
        ...
        protected override object ChangeListType(object value, Type destinationType, IXmlNamespaceResolver nsResolver)
        {
            ...
            if ((this.atomicConverter == null) || (!_allowListToList && sourceType != StringType && destinationType != StringType))
            {
                if (SupportsType(sourceType))
                    throw new InvalidCastException(string.Format(ResXml.XmlConvert_TypeToString, XmlTypeName, sourceType.Name));

                if (SupportsType(destinationType))
                    throw new InvalidCastException(string.Format(ResXml.XmlConvert_TypeFromString, XmlTypeName, destinationType.Name));
    ...
    internal class XmlListConverter : XmlBaseConverter
    {
        ...
        {
            if (sourceType == destinationType)
                return new InvalidCastException(string.Format(ResXml.XmlConvert_TypeListBadMapping, XmlTypeName, sourceType.Name));

            return new InvalidCastException(string.Format(ResXml.XmlConvert_TypeListBadMapping2, XmlTypeName, sourceType.Name, destinationType.Name));
        }
    }
