...
namespace Microsoft.Xml.Schema
{
    ...
    internal abstract class XmlBaseConverter : XmlValueConverter
    {
        ...
        protected Exception CreateInvalidClrMappingException(Type sourceType, Type destinationType)
        {
            ...
            return new InvalidCastException(ResXml.GetString(ResXml.XmlConvert_TypeBadMapping2, XmlTypeName, sourceType.Name, destinationType.Name));
        }
        ...
        protected static XmlQualifiedName StringToQName(string value, IXmlNamespaceResolver nsResolver)
        {
            ...
            if (nsResolver == null)
                throw new InvalidCastException(ResXml.GetString(ResXml.XmlConvert_TypeNoNamespace, value, prefix));
        ...
        protected static string QNameToString(XmlQualifiedName qname, IXmlNamespaceResolver nsResolver)
        {
            ...
            if (prefix == null)
                throw new InvalidCastException(ResXml.GetString(ResXml.XmlConvert_TypeNoPrefix, qname.ToString(), qname.Namespace));
        ...
        protected override object ChangeListType(object value, Type destinationType, IXmlNamespaceResolver nsResolver)
        {
            ...
            if ((this.atomicConverter == null) || (!_allowListToList && sourceType != StringType && destinationType != StringType))
            {
                ...
                if (SupportsType(destinationType))
                    throw new InvalidCastException(ResXml.GetString(ResXml.XmlConvert_TypeFromString, XmlTypeName, destinationType.Name));
    ...
    internal class XmlListConverter : XmlBaseConverter
    {
        ...
        private new Exception CreateInvalidClrMappingException(Type sourceType, Type destinationType)
        {
            ...
            return new InvalidCastException(ResXml.GetString(ResXml.XmlConvert_TypeListBadMapping2, XmlTypeName, sourceType.Name, destinationType.Name));
        }
    }
