...
namespace Microsoft.Xml.Schema
{
    ...
    internal abstract class DatatypeImplementation : XmlSchemaDatatype
    {
        ...
        private static XmlSchemaSimpleType s_anySimpleType;
        private static XmlSchemaSimpleType s_anyAtomicType;
        private static XmlSchemaSimpleType s_untypedAtomicType;
        ...
        internal static XmlSchemaSimpleType AnySimpleType { get { return s_anySimpleType; } }

        // Additional built-in XQuery simple types
        internal static XmlSchemaSimpleType AnyAtomicType { get { return s_anyAtomicType; } }
        internal static XmlSchemaSimpleType UntypedAtomicType { get { return s_untypedAtomicType; } }
        ...
        internal static void CreateBuiltinTypes()
        {
            ...
            s_anySimpleType = StartBuiltinType(qname, dt);
            dt._parentSchemaType = s_anySimpleType;
            s_builtinTypes.Add(qname, s_anySimpleType);
            ...
            for (int i = 0; i < s_xsdTypes.Length; i++)
            {
                ...
                {
                    FinishBuiltinType(derivedType, s_anySimpleType);
                }
                else
            ...
            s_anyAtomicType = StartBuiltinType(qname, s_c_anyAtomicType);
            s_c_anyAtomicType._parentSchemaType = s_anyAtomicType;
            FinishBuiltinType(s_anyAtomicType, s_anySimpleType);
            s_builtinTypes.Add(qname, s_anyAtomicType);
            s_enumToTypeCode[(int)XmlTypeCode.AnyAtomicType] = s_anyAtomicType;
            ...
            s_untypedAtomicType = StartBuiltinType(qname, s_c_untypedAtomicType);
            s_c_untypedAtomicType._parentSchemaType = s_untypedAtomicType;
            FinishBuiltinType(s_untypedAtomicType, s_anyAtomicType);
            s_builtinTypes.Add(qname, s_untypedAtomicType);
            s_enumToTypeCode[(int)XmlTypeCode.UntypedAtomic] = s_untypedAtomicType;
        ...
        internal XmlSchemaDatatype DeriveByList(int minSize, XmlSchemaType schemaType)
        {
            ...
            {
                throw new XmlSchemaException(ResXml.Sch_ListFromNonatomic, string.Empty);
            }
            ...
            dt._baseType = s_c_anySimpleType; //Base type of a union is anySimpleType
            dt._parentSchemaType = schemaType;
            return dt;
        }
        ...
        public override bool IsDerivedFrom(XmlSchemaDatatype datatype)
        {
            ...
            { //derived type is union (not a restriction)
                return (datatype == s_anySimpleType.Datatype);
            }
            return false;
        }
        ...
        public override object ParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr)
        {
            ...
            if (exception != null)
            {
                throw new XmlSchemaException(ResXml.Sch_InvalidValueDetailed, new string[] { s, GetTypeName(), exception.Message }, exception, null, 0, 0, null);
            }
        ...
        // XSD types
        static private readonly DatatypeImplementation s_c_anySimpleType = new Datatype_anySimpleType();
        ...
        // XQuery types
        static private readonly DatatypeImplementation s_c_anyAtomicType = new Datatype_anyAtomicType();
        static private readonly DatatypeImplementation s_dayTimeDuration = new Datatype_dayTimeDuration();
        static private readonly DatatypeImplementation s_c_untypedAtomicType = new Datatype_untypedAtomicType();
        ...
        private static readonly SchemaDatatypeMap[] s_xsdTypes = {
            ...
            new SchemaDatatypeMap("anySimpleType",      s_c_anySimpleType, -1),
    ...
    internal class Datatype_union : Datatype_anySimpleType
    {
        ...
        internal override Exception TryParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
        {
            ...
            if (memberType == null)
            {
                exception = new XmlSchemaException(ResXml.Sch_UnionFailedEx, s);
                goto Error;
            }
        ...
        internal override Exception TryParseValue(object value, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
        {
            ...
            {
                exception = new XmlSchemaException(ResXml.Sch_UnionFailedEx, value.ToString());
                goto Error;
            }
            try
            {
    ...
    */
    ...
    internal class Datatype_dateTimeBase : Datatype_anySimpleType
    {
        ...
        internal override Exception TryParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
        {
            ...
            {
                exception = new FormatException(ResXml.GetString(ResXml.XmlConvert_BadFormat, s, _dateTimeFlags.ToString()));
                goto Error;
            }
            ...
            for (Datatype_NOTATION dt = this; dt != null; dt = (Datatype_NOTATION)dt.Base)
            {
                if (dt.Restriction != null && (dt.Restriction.Flags & RestrictionFlags.Enumeration) != 0)
                {
                    for (int i = 0; i < dt.Restriction.Enumeration.Count; ++i)
                    {
                        ...
                        {
                            throw new XmlSchemaException(ResXml.Sch_NotationRequired, caller);
                        }
                    }
                    return;
                }
    ...
    */
    internal class Datatype_doubleXdr : Datatype_double
    {
        public override object ParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr)
        {
            ...
            {
                throw new XmlSchemaException(ResXml.GetString(ResXml.Sch_InvalidValue, s), e);
            }
            if (double.IsInfinity(value) || double.IsNaN(value))
            {
                throw new XmlSchemaException(ResXml.Sch_InvalidValue, s);
            }
            return value;
        }
    }
    ...
    internal class Datatype_QNameXdr : Datatype_anySimpleType
    {
        ...
        public override object ParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr)
        {
            if (s == null || s.Length == 0)
            {
                throw new XmlSchemaException(ResXml.Sch_EmptyAttributeValue, string.Empty);
            }
            if (nsmgr == null)
            {
