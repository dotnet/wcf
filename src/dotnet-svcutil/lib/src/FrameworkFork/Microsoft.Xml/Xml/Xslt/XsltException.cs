...
// 				using Microsoft.Xml;
// 
//     using Res = Microsoft.Xml.Utils.Res;
// 
//     // [Serializable],
...
//                     message += " " + FormatMessage(Res.Xml_ErrorFilePosition, sourceUri, lineNumber.ToString(), linePosition.ToString());
//                 }
//                 return message;
//             }
...
//                 new string[] { sourceUri, lineNumber.ToString(), linePosition.ToString() },
