...
namespace Microsoft.Xml.Xsl {
    ...
    public sealed class XslCompiledTransform {
        ...
        public void Load(Type compiledStylesheet) {
            ...
            if (generatedCodeAttr != null && generatedCodeAttr.Tool == typeof(XslCompiledTransform).FullName) {
                ...
                if(new Version(Version).CompareTo(new Version(generatedCodeAttr.Version)) < 0) {
                    throw new ArgumentException(ResXml.GetString(ResXml.Xslt_IncompatibleCompiledStylesheetVersion, generatedCodeAttr.Version, Version), "compiledStylesheet");
                }
                ...
                if (fldData != null && fldTypes != null) {
                    if (Microsoft.Xml.XmlConfiguration.XsltConfigSection.EnableMemberAccessForXslCompiledTransform)
                    {
            ...
            if (this.command == null)
                throw new ArgumentException(ResXml.GetString(ResXml.Xslt_NotCompiledStylesheet, compiledStylesheet.FullName), "compiledStylesheet");
        }
        ...
        private void CheckCommand() {
            if (this.command == null) {
                throw new InvalidOperationException(ResXml.GetString(ResXml.Xslt_NoStylesheetLoaded));
            }
        }
