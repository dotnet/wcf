...
//             return "Read" + (++NextMethodNumber).ToString() + "_" + CodeIdentifier.MakeValidInternal(name);
//         }
//         
//         string NextIdName(string name) {
//             return "id" + (++nextIdNumber).ToString() + "_" + CodeIdentifier.MakeValidInternal(name);
//         }
// 
...
//                 else{
//                     Writer.Write(", ");
//                     Writer.Write(constants[i].Value.ToString()+"L");
//                 }
// 
//                 Writer.WriteLine(");");
//             }
...
//             if (structMapping.TypeDesc.IsRoot) {
//                 Writer.Indent++;
//                 Writer.WriteLine("return ReadTypedPrimitive(new Microsoft.Xml.XmlQualifiedName(\"" + Soap.UrType + "\", \"" + XmlSchema.Namespace + "\"));");
//                 Writer.Indent--;
//             }
//             Writer.WriteLine("}");
