    ...
    internal abstract class WSSecurityPolicy
    {
                ...
                && TryGetNestedPolicyAlternatives(importer, assertion, out alternatives))
            {
                ...
                try
                {
                    ...
                    if (importer.State.ContainsKey(SecurityBindingElementImporter.SecureConversationBootstrapEncryptionRequirements))
                    {
                        ...
                        {
                            importer.Errors.Add(new MetadataConversionError(SRServiceModel.UnsupportedSecureConversationBootstrapProtectionRequirements, false));
        ...
        private class TokenIssuerPolicyResolver
        {
            ...
            public void ResolveTokenIssuerPolicy(MetadataImporter importer, PolicyConversionContext policyContext, IssuedSecurityTokenParameters parameters)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SRServiceModel.MaximumPolicyRedirectionsExceeded));
                }
                --maximumRedirections;
                ...
                // NOTE: hsomu, Policy import/export is seperate from WSDL however, this policy importer
