...
namespace System.ServiceModel.Activation
{
    ...
    static class ListenerUnsafeNativeMethods
    {
        ...
        internal struct TOKEN_GROUPS
        {
            ...
            internal IntPtr _groups; // array of SID_AND_ATTRIBUTES
        }

        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        internal struct SID_AND_ATTRIBUTES
        {
            internal IntPtr _sid;
            internal SidAttribute _attributes;
        }

        [StructLayout(LayoutKind.Sequential)]
        internal struct SERVICE_STATUS_PROCESS
        {
            internal int _dwServiceType;
            internal int _dwCurrentState;
            internal int _dwControlsAccepted;
            internal int _dwWin32ExitCode;
            internal int _dwServiceSpecificExitCode;
            internal int _dwCheckPoint;
            internal int _dwWaitHint;
        ...
        {
            internal int _privilegeCount;
            internal LUID_AND_ATTRIBUTES _privileges; // array of LUID_AND_ATTRIBUTES
        }
...
#pragma warning suppress 56523 // elliotw, should only fail if there is a bug (invalid handle); MDA will be raised
            ListenerUnsafeNativeMethods.CloseServiceHandle(handle);
#pragma warning restore CS1634 // Expected 'disable' or 'restore' after #pragma warning
    }
    ...
    {
        internal LUID _luid;
        internal SafeCloseHandle.PrivilegeAttribute _attributes;
    }

    [StructLayout(LayoutKind.Sequential)]
    struct LUID
    {
        internal uint _lowPart;
        internal int _highPart;
    }
}
