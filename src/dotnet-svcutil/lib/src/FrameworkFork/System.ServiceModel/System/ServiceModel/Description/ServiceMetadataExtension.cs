...
namespace System.ServiceModel.Description
{
    ...
    public class ServiceMetadataExtension //TODO : IExtension<ServiceHostBase>
    {
        ...
        void IExtension<ServiceHostBase>.Detach(ServiceHostBase owner)
        {
            ...
            if (this.owner != owner)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("owner", SR.TheServiceMetadataExtensionInstanceCouldNot4_0);
        ...
        internal class WSMexImpl : IMetadataExchange
        {
            ...
            string GetLocationToReturn()
            {
                ...
                if (!location.IsAbsoluteUri)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("ExternalMetadataLocation", SR.Format(SR.SFxBadMetadataLocationNoAppropriateBaseAddress, this.parent.ExternalMetadataLocation.OriginalString));
                    }
                }
        ...
        internal class HttpGetImpl : IHttpGetMetadata, IDispatchMessageInspector
        {
            ...
            public void BeforeSendReply(ref Message reply, object correlationState)
            {
                ...
                {
                    string error = SR.SFxInternalServerError;
        ...
        #region Helper Message implementations
            ...
            class MetadataOnHelpPageMessage : ContentOnlyMessage
            {
                ...
                protected override void OnWriteBodyContents(XmlDictionaryWriter writer)
                {
                    ...
                    page.WriteTitle(!String.IsNullOrEmpty(this.serviceName) ? SR.Format(SR.SFxDocExt_MainPageTitle, this.serviceName) : SR.SFxDocExt_MainPageTitleNoServiceName);
                ...
                struct HelpPageWriter
                {
                    ...
                    internal void WriteToolUsage(string wsdlUrl, string singleWsdlUrl, bool linkMetadata)
                    {
                        ...
                        if (wsdlUrl != null)
                        {
                            WriteMetadataAddress(SR.SFxDocExt_MainPageIntro1a, Microsoft.Tools.ServiceModel.Svcutil.Tool.FileName, wsdlUrl, linkMetadata);
