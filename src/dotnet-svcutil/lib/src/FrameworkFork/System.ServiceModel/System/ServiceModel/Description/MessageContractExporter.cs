...
//                     {
//                         throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.CannotHaveTwoOperationsWithTheSameElement5, parentOperation.OperationMethod.DeclaringType, parentOperation.OperationMethod.Name, qname, existingElement.Operation.OperationMethod.DeclaringType, existingElement.Operation.Name)));
//                     }
//                     return;
//                 }
//                 else
...
//             xsdType = null;
//             if (type == null)
//                 throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.SFxExportMustHaveType, operationName, partName)));
//             if (type == typeof(void))
//                 return null;
// 
...
//                     throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.SFxPartNameMustBeUniqueInRpc, partName)));
//                 int i = 1;
//                 while (message.Parts[partName + i] != null)
//                 {
//                     if (i == Int32.MaxValue)
//                         throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.Format(SR.SFxTooManyPartsWithSameName, partName)));
//                     i++;
//                 }
...
//                 throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.MultipleCallsToExportContractWithSameContract));
// 
...
//                     throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.SFxAnonymousTypeNotSupported, message.Name, partName)));
// 
