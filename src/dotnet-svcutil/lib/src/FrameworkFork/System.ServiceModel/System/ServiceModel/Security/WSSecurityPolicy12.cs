...
//                     throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.Format(SR.UnsupportedSecurityPolicyAssertion, assertion.OuterXml)));
//             }
// 
//             return true;
//         }
