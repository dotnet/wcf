...
namespace System.ServiceModel.Channels
{
    public abstract class SecurityBindingElement : BindingElement
    {
...
#if disabled
        private InternalDuplexBindingElement _internalDuplexBindingElement;
#endif
...
#if disabled
            _internalDuplexBindingElement = elementToBeCloned._internalDuplexBindingElement;
#endif
        ...
        private static BindingContext CreateIssuerBindingContextForNegotiation(BindingContext issuerBindingContext)
        {
            ...
            if (demuxer == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR.ChannelDemuxerBindingElementNotFound));
            }
        ...
        public override bool CanBuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            InternalDuplexBindingElement.AddDuplexFactorySupport(context, ref _internalDuplexBindingElement);
            if (this.SessionMode)
            {
        ...
        public override bool CanBuildChannelListener<TChannel>(BindingContext context)
        {
            ...
            InternalDuplexBindingElement.AddDuplexListenerSupport(context, ref _internalDuplexBindingElement);
        ...
        private bool CanBuildSessionChannelListener<TChannel>(BindingContext context)
            where TChannel : class, IChannel
        {
