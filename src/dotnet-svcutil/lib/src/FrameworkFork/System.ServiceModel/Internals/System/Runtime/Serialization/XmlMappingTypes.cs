...
{
    // The classes in this file are used for invoking APIs that exist in Microsoft.Xml.XmlSerializer  
    ...
    {
        private static string s_xmlReflectionImporterTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlReflectionImporter");
        private static string s_xmlMappingTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlMapping");
        private static string s_xmlTypeMappingTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlTypeMapping");
        private static string s_xmlMembersMappingTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlMembersMapping");
        private static string s_xmlMemberMappingTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlMemberMapping");
        private static string s_xmlReflectionMemberTypeName = XmlMappingTypesHelper.GetAssemblyQualifiedTypeName("Microsoft.Xml.Serialization.XmlReflectionMember");
        ...
        private static string XmlSerializerAssemblyName
        {
            get
            {
                ...
                {
                    Type type = typeof(Microsoft.Xml.Serialization.XmlSerializer);
