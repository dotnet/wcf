...
#region class CSharpCodeGenerator
    ...
    internal class CSharpCodeGenerator : ICodeCompiler, ICodeGenerator{
        ...
        private  void GenerateCompileUnitStart(CodeCompileUnit e) {
            ...
            Output.Write("//     ");
            Output.WriteLine(SRCodeDom.GetString(SRCodeDom.AutoGen_Comment_Line2));
#if disabled
            Output.Write("//     ");
            ...
            Output.WriteLine("//");
            Output.Write("//     ");
            Output.WriteLine(SRCodeDom.GetString(SRCodeDom.AutoGen_Comment_Line4));
            Output.Write("//     ");
            Output.WriteLine(SRCodeDom.GetString(SRCodeDom.AutoGen_Comment_Line5));
            Output.WriteLine("// </auto-generated>");            
            Output.WriteLine("//------------------------------------------------------------------------------");
            Output.WriteLine("");
        ...
        internal void Compile(CompilerParameters options, string compilerDirectory, string compilerExe, string arguments,
            ...
            if (File.Exists(fullname)) {
                ...
                nativeReturnValue = Executor.ExecWaitWithCapture(options.SafeUserToken, "\"" + fullname + "\" " + arguments,
                                                                 Directory.GetCurrentDirectory(), options.TempFiles, ref outputFile, ref errorFile,
                                                                 trueCmdLine);
            }
            else {
    ...
    internal abstract class CSharpModifierAttributeConverter : TypeConverter {          
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            ...
            if (destinationType == typeof(string)) {
                ...
                return SRCodeDom.GetString(SRCodeDom.toStringUnknown);
            }
