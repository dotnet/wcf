        ...
        private static void WriteCodeGenerationHelp()
        {
            HelpCategory helpCategory = new HelpCategory(SR.HelpUsageCategory)
            {
                ...
                Options = new ArgumentInfo[] {
                    ...
                    ArgumentInfo.CreateFlagHelpInfo(     CommandProcessorOptions.Switches.NoAsync.Name,                                                             string.Format(SR.HelpNoAsyncFormat, CommandProcessorOptions.Switches.NoAsync.Abbreviation)),
