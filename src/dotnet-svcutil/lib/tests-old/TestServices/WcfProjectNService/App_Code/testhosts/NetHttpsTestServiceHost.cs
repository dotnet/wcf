...
namespace WcfProjectNService
{
    ...
    public class NetHttpsTestServiceHost : TestServiceHostBase<IWcfProjectNService>
    {
    ...
    public class NetHttpsTestServiceHostUsingWebSockets : TestServiceHostBase<IWcfProjectNService>
    {
