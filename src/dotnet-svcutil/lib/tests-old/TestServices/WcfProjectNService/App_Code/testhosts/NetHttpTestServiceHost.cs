...
namespace WcfProjectNService
{
    ...
    public class NetHttpTestServiceHost : TestServiceHostBase<IWcfProjectNService>
    {
    ...
    public class NetHttpTestServiceHostUsingWebSockets : TestServiceHostBase<IWcfProjectNService>
    {
