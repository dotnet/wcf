...
namespace BasicHttpDocLitDualNs_NS
{
    ...
    public partial class CalculatorDocLitClient : System.ServiceModel.ClientBase<BasicHttpDocLitDualNs_NS.ICalculatorDocLit>, BasicHttpDocLitDualNs_NS.ICalculatorDocLit
    {
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.BasicHttpBinding_ICalculatorDocLit.ToString();
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICalculatorDocLit))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICalculatorDocLit))
            {
                return new System.ServiceModel.EndpointAddress("http://wcfcoresrv5.cloudapp.net/WcfTestService1/BasicHttpDocLitDualNs.svc/Basic");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        {
            return CalculatorDocLitClient.GetBindingForEndpoint(EndpointConfiguration.BasicHttpBinding_ICalculatorDocLit);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return CalculatorDocLitClient.GetEndpointAddress(EndpointConfiguration.BasicHttpBinding_ICalculatorDocLit);
        }
        
        public enum EndpointConfiguration
        {
            
            BasicHttpBinding_ICalculatorDocLit,
        }
    }
    ...
    public partial class HelloWorldDocLitClient : System.ServiceModel.ClientBase<BasicHttpDocLitDualNs_NS.IHelloWorldDocLit>, BasicHttpDocLitDualNs_NS.IHelloWorldDocLit
    {
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.BasicHttpBinding_IHelloWorldDocLit.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IHelloWorldDocLit))
            {
                System.ServiceModel.BasicHttpBinding result = new System.ServiceModel.BasicHttpBinding();
                result.MaxBufferSize = int.MaxValue;
                result.ReaderQuotas = System.Xml.XmlDictionaryReaderQuotas.Max;
        ...
        private static System.ServiceModel.Channels.Binding GetDefaultBinding()
        {
            return HelloWorldDocLitClient.GetBindingForEndpoint(EndpointConfiguration.BasicHttpBinding_IHelloWorldDocLit);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return HelloWorldDocLitClient.GetEndpointAddress(EndpointConfiguration.BasicHttpBinding_IHelloWorldDocLit);
        }
        
        public enum EndpointConfiguration
        {
            
            BasicHttpBinding_IHelloWorldDocLit,
        }
    }
}