...
namespace BasicHttpRpcLitDualNs_NS
{
    ...
    public partial class CalculatorRpcLitClient : System.ServiceModel.ClientBase<BasicHttpRpcLitDualNs_NS.ICalculatorRpcLit>, BasicHttpRpcLitDualNs_NS.ICalculatorRpcLit
    {
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.BasicHttpBinding_ICalculatorRpcLit.ToString();
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICalculatorRpcLit))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICalculatorRpcLit))
            {
                return new System.ServiceModel.EndpointAddress("http://wcfcoresrv5.cloudapp.net/WcfTestService1/BasicHttpRpcLitDualNs.svc/Basic");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        {
            return CalculatorRpcLitClient.GetBindingForEndpoint(EndpointConfiguration.BasicHttpBinding_ICalculatorRpcLit);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return CalculatorRpcLitClient.GetEndpointAddress(EndpointConfiguration.BasicHttpBinding_ICalculatorRpcLit);
        }
        
        public enum EndpointConfiguration
        {
            
            BasicHttpBinding_ICalculatorRpcLit,
        }
    }
    ...
    public partial class HelloWorldRpcLitClient : System.ServiceModel.ClientBase<BasicHttpRpcLitDualNs_NS.IHelloWorldRpcLit>, BasicHttpRpcLitDualNs_NS.IHelloWorldRpcLit
    {
        ...
        {
            this.Endpoint.Name = EndpointConfiguration.BasicHttpBinding_IHelloWorldRpcLit.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IHelloWorldRpcLit))
            {
                System.ServiceModel.BasicHttpBinding result = new System.ServiceModel.BasicHttpBinding();
                result.MaxBufferSize = int.MaxValue;
                result.ReaderQuotas = System.Xml.XmlDictionaryReaderQuotas.Max;
        ...
        private static System.ServiceModel.Channels.Binding GetDefaultBinding()
        {
            return HelloWorldRpcLitClient.GetBindingForEndpoint(EndpointConfiguration.BasicHttpBinding_IHelloWorldRpcLit);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return HelloWorldRpcLitClient.GetEndpointAddress(EndpointConfiguration.BasicHttpBinding_IHelloWorldRpcLit);
        }
        
        public enum EndpointConfiguration
        {
            
            BasicHttpBinding_IHelloWorldRpcLit,
        }
    }
}