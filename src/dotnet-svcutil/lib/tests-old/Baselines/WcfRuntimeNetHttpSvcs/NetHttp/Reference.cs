...
namespace NetHttp_NS
{
    ...
    public partial class WcfServiceClient : System.ServiceModel.ClientBase<NetHttp_NS.IWcfService>, NetHttp_NS.IWcfService
    {
        ...
        public System.Threading.Tasks.Task<NetHttp_NS.XmlMessageContractTestResponse> EchoMessageResquestWithMessageHeaderAsync()
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.NetHttpBinding_IWcfService))
            {
                return new System.ServiceModel.EndpointAddress("http://wcfcoresrv5.cloudapp.net/WcfTestService1/NetHttp.svc/NetHttp");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
