...
|              |SPNIdentity    |[:no_entry_sign:](https://github.com/dotnet/wcf/releases/tag/v2.0)          |[:no_entry_sign:](https://github.com/dotnet/wcf/releases/tag/v2.0)          |[:no_entry_sign:](https://github.com/dotnet/wcf/releases/tag/v2.0)                  | [:no_entry_sign:](https://github.com/dotnet/wcf/releases/tag/v2.0)          |
|              |UPNIdentity    |[:no_entry_sign:](https://github.com/dotnet/wcf/releases/tag/v2.0)          |:white_check_mark:          |:white_check_mark:                  | :white_check_mark:          |
